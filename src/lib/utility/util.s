...
[0006b76c] 6c04                      bge.s      $0006B772
[0006b76e] 70ff                      moveq.l    #-1,d0
[0006b770] 6002                      bra.s      $0006B774
...
[0006b7e6] 6d04                      blt.s      $0006B7EC
[0006b7e8] 4240                      clr.w      d0
[0006b7ea] 601c                      bra.s      $0006B808
...
[0006b800] 6d04                      blt.s      $0006B806
[0006b802] 4240                      clr.w      d0
[0006b804] 6002                      bra.s      $0006B808
...
[0006bac8] 7003                      moveq.l    #3,d0 MU_BUTTON | MU_KEYBD
...
[0006bb02] 6700 02da                 beq        $0006BDDE
...
[0006bb50] 6700 028c                 beq        $0006BDDE
...
[0006bbfe] 6600 01de                 bne        $0006BDDE
...
[0006bde4] 6700 0110                 beq        $0006BEF6
...
[0006c192] 6700 0090                 beq        $0006C224
...
[0006c272] 6000 02a0                 bra        $0006C514
...
[0006c2f4] 6000 0156                 bra        $0006C44C
...
[0006c320] 6704                      beq.s      $0006C326
[0006c322] 6000 012c                 bra        $0006C450
...
[0006c424] 6702                      beq.s      $0006C428
[0006c426] 6028                      bra.s      $0006C450
[0006c428] 6022                      bra.s      $0006C44C
...
[0006c448] 6702                      beq.s      $0006C44C
[0006c44a] 6004                      bra.s      $0006C450
[0006c44c] 6000 feaa                 bra        $0006C2F8
...
[0006c4a8] 6602                      bne.s      $0006C4AC
[0006c4aa] 606c                      bra.s      $0006C518
...
[0006c514] 6000 fd60                 bra        $0006C276
...
[0006c792] 6006                      bra.s      $0006C79A
[0006c794] 6004                      bra.s      $0006C79A
...
[0006c854] 51c8 fffc                 dbf        d0,$0006C852
...
[0006c888] 6c0a                      bge.s      $0006C894
[0006c88a] 0c79 0200 0010 f55c       cmpi.w     #$0200,_ACSv_magix
[0006c892] 6d28                      blt.s      $0006C8BC
...
[0006c970] 6700 00ae                 beq        $0006CA20
[0006c974] 6000 008c                 bra        $0006CA02
...
[0006ca46] 51c8 fffc                 dbf        d0,$0006CA44
...
[0006cab2] 6700 0160                 beq        $0006CC14
[0006cab6] 6000 007c                 bra.w      $0006CB34
...
[0006caf8] 6630                      bne.s      $0006CB2A
[0006cafa] 202f 0192                 move.l     402(a7),d0
[0006cafe] 6712                      beq.s      $0006CB12
[0006cb00] 206f 0192                 movea.l    402(a7),a0
[0006cb04] 1010                      move.b     (a0),d0
[0006cb06] 670a                      beq.s      $0006CB12
[0006cb08] 206f 0192                 movea.l    402(a7),a0
[0006cb0c] 0c10 002a                 cmpi.b     #$2A,(a0)
[0006cb10] 6604                      bne.s      $0006CB16
[0006cb12] 6028                      bra.s      $0006CB3C
[0006cb14] 6014                      bra.s      $0006CB2A
...
[0006cb5a] 6608                      bne.s      $0006CB64
[0006cb5c] 3ebc 0001                 move.w     #$0001,(a7)
[0006cb60] 6000 0092                 bra        $0006CBF4
...
[0006cc44] 6700 0138                 beq        $0006CD7E
[0006cc48] 206f 0114                 movea.l    276(a7),a0
[0006cc4c] 1010                      move.b     (a0),d0
[0006cc4e] 6700 012e                 beq        $0006CD7E
...
[0006ccaa] 6606                      bne.s      $0006CCB2
[0006ccac] 4240                      clr.w      d0
[0006ccae] 6000 00d0                 bra        $0006CD80
[0006ccb2] 302f 010a                 move.w     266(a7),d0
[0006ccb6] 674a                      beq.s      $0006CD02
[0006ccb8] 202f 0002                 move.l     2(a7),d0
[0006ccbc] 6a16                      bpl.s      $0006CCD4
...
[0006ccce] 6a02                      bpl.s      $0006CCD2
[0006ccd0] 4257                      clr.w      (a7)
[0006ccd2] 602c                      bra.s      $0006CD00
...
[0006cce4] 6a04                      bpl.s      $0006CCEA
[0006cce6] 4257                      clr.w      (a7)
[0006cce8] 6016                      bra.s      $0006CD00
...
[0006cd28] 6a02                      bpl.s      $0006CD2C
[0006cd2a] 4257                      clr.w      (a7)
[0006cd2c] 3017                      move.w     (a7),d0
[0006cd2e] 6748                      beq.s      $0006CD78
