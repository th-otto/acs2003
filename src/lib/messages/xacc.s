...
[0005ecc0] 66c4                      bne.s      Aev_InitXAcc_5
Aev_InitXAcc_1:
...
[0005ecd6] 6736                      beq.s      XAccDataDelete_1
[0005ecd8] 2057                      movea.l    (a7),a0
[0005ecda] 2028 0006                 move.l     6(a0),d0
[0005ecde] 6722                      beq.s      XAccDataDelete_2
...
[0005ed66] 661a                      bne.s      Aev_GetAccID_1
[0005ed68] 2079 0010 ee4e            movea.l    ACSblk,a0
[0005ed6e] 3010                      move.w     (a0),d0
[0005ed70] 6610                      bne.s      Aev_GetAccID_1
...
[0005ed9c] 671e                      beq.s      Aev_GetAccID_2
...
[0005ee18] 6700 00ae                 beq        Aev_GetAccAck_1
...
[0005ee30] 670c                      beq.s      Aev_GetAccAck_2
...
[0005ee62] 6764                      beq.s      Aev_GetAccAck_1
...
[0005ee84] 6742                      beq.s      Aev_GetAccAck_1
[0005ee86] 2057                      movea.l    (a7),a0
[0005ee88] 2028 0002                 move.l     2(a0),d0
[0005ee8c] 671c                      beq.s      Aev_GetAccAck_3
...
[0005eeca] 6704                      beq.s      Aev_GetAccAck_4
[0005eecc] 7001                      moveq.l    #1,d0
[0005eece] 6002                      bra.s      Aev_GetAccAck_5
Aev_GetAccAck_4:
...
[0005ef20] 6740                      beq.s      Aev_GetAccAcc_3
...
[0005ef3e] 6704                      beq.s      Aev_GetAccAcc_4
[0005ef40] 7201                      moveq.l    #1,d1
[0005ef42] 6002                      bra.s      Aev_GetAccAcc_5
Aev_GetAccAcc_4:
...
[0005efbe] 6604                      bne.s      Aev_GetAccKey_1
[0005efc0] 7001                      moveq.l    #1,d0
[0005efc2] 6064                      bra.s      Aev_GetAccKey_2
Aev_GetAccKey_1:
...
[0005f010] 6d04                      blt.s      Aev_GetAccKey_3
[0005f012] 7201                      moveq.l    #1,d1
[0005f014] 6002                      bra.s      Aev_GetAccKey_4
Aev_GetAccKey_3:
...
[0005f04c] 6606                      bne.s      Aev_GetAccText_1
[0005f04e] 7001                      moveq.l    #1,d0
[0005f050] 6000 009e                 bra        Aev_GetAccText_2
Aev_GetAccText_1:
...
[0005f06a] 6750                      beq.s      Aev_GetAccText_3
...
[0005f0b8] 6036                      bra.s      Aev_GetAccText_2
[0005f0ba] 6034                      bra.s      Aev_GetAccText_2
Aev_GetAccText_3:
...
[0005f0ce] 670e                      beq.s      Aev_GetAccText_4
...
[0005f118] 6604                      bne.s      Aev_GetAccImg_1
[0005f11a] 7001                      moveq.l    #1,d0
[0005f11c] 6002                      bra.s      Aev_GetAccImg_2
Aev_GetAccImg_1:
...
[0005f178] 6000 01c8                 bra        Aev_GetAccImg_4
Aev_GetAccImg_7:
...
[0005f1e8] 671a                      beq.s      Aev_GetAccImg_9
...
[0005f25a] 6022                      bra.s      Aev_GetAccImg_10
Aev_GetAccImg_11:
...
[0005f2c6] 6022                      bra.s      Aev_GetAccImg_12
Aev_GetAccImg_13:
...
[0005f2da] 670e                      beq.s      Aev_GetAccImg_12
...
[0005f300] 6606                      bne.s      Aev_GetAccImg_16
[0005f302] 302f 000a                 move.w     10(a7),d0
[0005f306] 6622                      bne.s      Aev_GetAccImg_17
Aev_GetAccImg_16:
[0005f308] 302f 0008                 move.w     8(a7),d0
[0005f30c] 660c                      bne.s      Aev_GetAccImg_18
...
[0005f328] 6016                      bra.s      Aev_GetAccImg_19
Aev_GetAccImg_17:
...
[0005f36c] 6604                      bne.s      Aev_GetAccMeta_1
[0005f36e] 7001                      moveq.l    #1,d0
[0005f370] 6002                      bra.s      Aev_GetAccMeta_2
Aev_GetAccMeta_1:
...
[0005f3cc] 6000 0198                 bra        Aev_GetAccMeta_4
Aev_GetAccMeta_7:
...
[0005f464] 671a                      beq.s      Aev_GetAccMeta_9
...
[0005f4ea] 6022                      bra.s      Aev_GetAccMeta_10
Aev_GetAccMeta_11:
...
[0005f4fe] 670e                      beq.s      Aev_GetAccMeta_10
...
[0005f524] 6606                      bne.s      Aev_GetAccMeta_14
[0005f526] 302f 000a                 move.w     10(a7),d0
[0005f52a] 6622                      bne.s      Aev_GetAccMeta_15
Aev_GetAccMeta_14:
[0005f52c] 302f 0008                 move.w     8(a7),d0
[0005f530] 660c                      bne.s      Aev_GetAccMeta_16
...
[0005f54c] 6016                      bra.s      Aev_GetAccMeta_17
Aev_GetAccMeta_15:
...
[0005f59a] 6766                      beq.s      Aev_AccID_2
...
[0005f5d2] 6b1a                      bmi.s      Aev_AccID_3
...
[0005f5ea] 6018                      bra.s      Aev_AccID_4
[0005f5ec] 6014                      bra.s      Aev_AccID_2
Aev_AccID_3:
...
[0005f600] 6002                      bra.s      Aev_AccID_4
Aev_AccID_2:
...
[0005f63a] 6700 00ac                 beq        Aev_AccAcc_2
...
[0005f65a] 6726                      beq.s      Aev_AccAcc_3
...
[0005f680] 6032                      bra.s      Aev_AccAcc_4
Aev_AccAcc_3:
...
[0005f6b8] 6b1a                      bmi.s      Aev_AccAcc_5
...
[0005f6d0] 6018                      bra.s      Aev_AccAcc_6
[0005f6d2] 6014                      bra.s      Aev_AccAcc_2
Aev_AccAcc_5:
...
[0005f6e6] 6002                      bra.s      Aev_AccAcc_6
Aev_AccAcc_2:
...
[0005f71c] 6756                      beq.s      Aev_AccExit_2
...
[0005f744] 6b1a                      bmi.s      Aev_AccExit_3
...
[0005f75c] 6018                      bra.s      Aev_AccExit_4
[0005f75e] 6014                      bra.s      Aev_AccExit_2
Aev_AccExit_3:
...
[0005f772] 6002                      bra.s      Aev_AccExit_4
Aev_AccExit_2:
...
[0005f7a4] 6756                      beq.s      Aev_AccAck_2
...
[0005f7e8] 6014                      bra.s      Aev_AccAck_6
[0005f7ea] 6010                      bra.s      Aev_AccAck_2
Aev_AccAck_5:
...
[0005f7fa] 6002                      bra.s      Aev_AccAck_6
Aev_AccAck_2:
