...
[0006fbac] 6606                      bne.s      $0006FBB4
[0006fbae] 70fd                      moveq.l    #-3,d0
[0006fbb0] 6000 03aa                 bra        $0006FF5C
[0006fbb4] 4eb9 0006 ff64            jsr        hasFnts
[0006fbba] 4a40                      tst.w      d0
[0006fbbc] 6606                      bne.s      $0006FBC4
[0006fbbe] 70fe                      moveq.l    #-2,d0
[0006fbc0] 6000 039a                 bra        $0006FF5C
...
[0006fbd4] 6606                      bne.s      $0006FBDC
[0006fbd6] 70ff                      moveq.l    #-1,d0
[0006fbd8] 6000 0382                 bra        $0006FF5C
...
[0006fd12] 6a08                      bpl.s      $0006FD1C
[0006fd14] 203c 0001 0000            move.l     #$00010000,d0
[0006fd1a] 6008                      bra.s      $0006FD24
...
[0006fd40] 6600 0140                 bne        $0006FE82
[0006fd44] 202f 003e                 move.l     62(a7),d0
[0006fd48] 6600 00f8                 bne        $0006FE42
...
[0006fd64] 6704                      beq.s      $0006FD6A
[0006fd66] 4240                      clr.w      d0
[0006fd68] 6002                      bra.s      $0006FD6C
...
[0006fdb2] 6700 008e                 beq        $0006FE42
...
[0006ff40] 6706                      beq.s      $0006FF48
[0006ff42] 3ebc 0002                 move.w     #$0002,(a7)
[0006ff46] 6012                      bra.s      $0006FF5A
...
[00070118] 6200 009a                 bhi        $000701B4
[0007011c] d040                      add.w      d0,d0
[0007011e] 303b 0006                 move.w     $00070126(pc,d0.w),d0
[00070122] 4efb 0002                 jmp        $00070126(pc,d0.w)
J60:
[00070126] 008e                      dc.w $008e   ; $000701b4-$00070126
[00070128] 000c                      dc.w $000c   ; $00070132-$00070126
[0007012a] 0018                      dc.w $0018   ; $0007013e-$00070126
[0007012c] 0022                      dc.w $0022   ; $00070148-$00070126
[0007012e] 0046                      dc.w $0046   ; $0007016c-$00070126
[00070130] 006a                      dc.w $006a   ; $00070190-$00070126
[00070132] 2057                      movea.l    (a7),a0
[00070134] 317c 0001 002a            move.w     #$0001,42(a0)
[0007013a] 6000 0078                 bra.w      $000701B4
[0007013e] 2057                      movea.l    (a7),a0
[00070140] 317c 0001 002a            move.w     #$0001,42(a0)
[00070146] 606c                      bra.s      $000701B4
[00070148] 2057                      movea.l    (a7),a0
[0007014a] 2028 0030                 move.l     48(a0),d0
[0007014e] 671a                      beq.s      $0007016A
...
[000701d4] 6606                      bne.s      $000701DC
[000701d6] 91c8                      suba.l     a0,a0
[000701d8] 6000 0086                 bra        $00070260
...
[000701ec] 6604                      bne.s      $000701F2
[000701ee] 91c8                      suba.l     a0,a0
[000701f0] 606e                      bra.s      $00070260
...
[00070218] 6704                      beq.s      $0007021E
[0007021a] 4240                      clr.w      d0
[0007021c] 6002                      bra.s      $00070220
...
[0007034e] 6f00 00b6                 ble        $00070406
...
[00070402] 6006                      bra.s      $0007040A
[00070404] 6004                      bra.s      $0007040A
...
[0007042a] 51c8 fffc                 dbf        d0,$00070428
...
[000704b6] 51c8 fffc                 dbf        d0,$000704B4
...
[00070568] 51c8 fffc                 dbf        d0,$00070566
...
[00070612] 51c8 fffc                 dbf        d0,$00070610
...
[000706a2] 51c8 fffc                 dbf        d0,$000706A0
...
[00070734] 51c8 fffc                 dbf        d0,$00070732
...
[000707c6] 51c8 fffc                 dbf        d0,$000707C4
...
[00070844] 51c8 fffc                 dbf        d0,$00070842
...
[000708d0] 51c8 fffc                 dbf        d0,$000708CE
...
[00070a0e] 51c8 fffc                 dbf        d0,$00070A0C
...
[00070b9e] 51c8 fffc                 dbf        d0,$00070B9C
