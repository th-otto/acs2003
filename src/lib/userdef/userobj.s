...
[00062618] 6606                      bne.s      $00062620
[0006261a] 70ff                      moveq.l    #-1,d0
[0006261c] 6000 0580                 bra        $00062B9E
...
[00062630] 6700 0096                 beq        $000626C8
...
[00062644] 6700 0082                 beq        $000626C8
...
[000626c4] 6600 00f4                 bne        $000627BA
...
[000627b6] 6000 03e6                 bra        $00062B9E
...
[000627d0] 6f26                      ble.s      $000627F8
[000627d2] 426f 0002                 clr.w      2(a7)
[000627d6] 6018                      bra.s      $000627F0
...
[00062868] 6f26                      ble.s      $00062890
[0006286a] 426f 0002                 clr.w      2(a7)
[0006286e] 6018                      bra.s      $00062888
...
[00062900] 6f26                      ble.s      $00062928
[00062902] 426f 0002                 clr.w      2(a7)
[00062906] 6018                      bra.s      $00062920
...
[00062998] 6f26                      ble.s      $000629C0
[0006299a] 426f 0002                 clr.w      2(a7)
[0006299e] 6018                      bra.s      $000629B8
...
[00062d5a] 6600 011e                 bne        $00062E7A
...
[00062fbc] 6600 00da                 bne        $00063098
...
[00063112] 6200 010c                 bhi        $00063220
[00063116] d040                      add.w      d0,d0
[00063118] 303b 0006                 move.w     $00063120(pc,d0.w),d0
[0006311c] 4efb 0002                 jmp        $00063120(pc,d0.w)
J47:
[00063120] 0100                      dc.w $0100   ; $00063220-$00063120
[00063122] 002a                      dc.w $002a   ; $0006314a-$00063120
[00063124] 0086                      dc.w $0086   ; $000631a6-$00063120
[00063126] 00ce                      dc.w $00ce   ; $000631ee-$00063120
[00063128] 0096                      dc.w $0096   ; $000631b6-$00063120
[0006312a] 00da                      dc.w $00da   ; $000631fa-$00063120
[0006312c] 00da                      dc.w $00da   ; $000631fa-$00063120
[0006312e] 0100                      dc.w $0100   ; $00063220-$00063120
[00063130] 0100                      dc.w $0100   ; $00063220-$00063120
[00063132] 0062                      dc.w $0062   ; $00063182-$00063120
[00063134] 0100                      dc.w $0100   ; $00063220-$00063120
[00063136] 0100                      dc.w $0100   ; $00063220-$00063120
[00063138] 0100                      dc.w $0100   ; $00063220-$00063120
[0006313a] 0100                      dc.w $0100   ; $00063220-$00063120
[0006313c] 0100                      dc.w $0100   ; $00063220-$00063120
[0006313e] 0100                      dc.w $0100   ; $00063220-$00063120
[00063140] 0100                      dc.w $0100   ; $00063220-$00063120
[00063142] 0100                      dc.w $0100   ; $00063220-$00063120
[00063144] 0100                      dc.w $0100   ; $00063220-$00063120
[00063146] 0094                      dc.w $0094   ; $000631b4-$00063120
[00063148] 0094                      dc.w $0094   ; $000631b4-$00063120
[0006314a] 2057                      movea.l    (a7),a0
[0006314c] 2028 000c                 move.l     12(a0),d0
[00063150] 6712                      beq.s      $00063164
...
[0006317e] 6000 00a4                 bra        $00063224
...
[0006321e] 6004                      bra.s      $00063224
[00063220] 4240                      clr.w      d0
[00063222] 6002                      bra.s      $00063226
...
[0006335e] 6f00 0224                 ble        $00063584
...
[00063386] 6600 01b8                 bne        $00063540
...
[00063604] 6700 013e                 beq        $00063744
...
[00063afa] 6700 00cc                 beq        $00063BC8
...
[00063bc4] 6000 0198                 bra        $00063D5E
[00063bc8] 302f 001c                 move.w     28(a7),d0
[00063bcc] 6f00 009e                 ble        $00063C6C
...
[00063c68] 6000 008a                 bra        $00063CF4
...
[00063d5e] 6000 04cc                 bra        $0006422C
...
[00063d80] 6700 0184                 beq        $00063F06
...
[00063e82] 6700 007e                 beq.w      $00063F02
...
[00063f02] 6000 0328                 bra        $0006422C
...
[00063f7c] 6f00 0098                 ble        $00064016
...
[00064012] 6000 008a                 bra        $0006409E
...
[00064140] 6700 00ea                 beq        $0006422C
...
[00064370] 6600 0606                 bne        $00064978
...
[00064532] 6042                      bra.s      $00064576
[00064534] 0c6f 0007 0016            cmpi.w     #$0007,22(a7)
[0006453a] 6614                      bne.s      $00064550
...
[000645e6] 6700 0390                 beq        $00064978
...
[000645fc] 6f00 037a                 ble        $00064978
...
[00064780] 6200 012a                 bhi        $000648AC
[00064784] d040                      add.w      d0,d0
[00064786] 303b 0006                 move.w     $0006478E(pc,d0.w),d0
[0006478a] 4efb 0002                 jmp        $0006478E(pc,d0.w)
J48:
[0006478e] 011e                      dc.w $011e   ; $000648ac-$0006478e
[00064790] 000e                      dc.w $000e   ; $0006479c-$0006478e
[00064792] 0038                      dc.w $0038   ; $000647c6-$0006478e
[00064794] 011e                      dc.w $011e   ; $000648ac-$0006478e
[00064796] 006a                      dc.w $006a   ; $000647f8-$0006478e
[00064798] 00a2                      dc.w $00a2   ; $00064830-$0006478e
[0006479a] 00dc                      dc.w $00dc   ; $0006486a-$0006478e
...
[000647c2] 6000 010a                 bra        $000648CE
...
[000647f4] 6000 00d8                 bra        $000648CE
...
[0006482c] 6000 00a0                 bra        $000648CE
...
[00064b3c] 6606                      bne.s      $00064B44
[00064b3e] 426f 002a                 clr.w      42(a7)
[00064b42] 600c                      bra.s      $00064B50
...
[00064d2c] 6042                      bra.s      $00064D70
[00064d2e] 0c6f 0007 0032            cmpi.w     #$0007,50(a7)
[00064d34] 6614                      bne.s      $00064D4A
...
[00064dae] 6f00 020e                 ble        $00064FBE
...
[00064dc4] 672c                      beq.s      $00064DF2
[00064dc6] 302f 002e                 move.w     46(a7),d0
[00064dca] 660e                      bne.s      $00064DDA
...
[00064f72] 6706                      beq.s      $00064F7A
[00064f74] 5340                      subq.w     #1,d0
[00064f76] 670a                      beq.s      $00064F82
[00064f78] 6018                      bra.s      $00064F92
[00064f7a] 3f6f 005e 0022            move.w     94(a7),34(a7)
[00064f80] 6024                      bra.s      $00064FA6
...
[0006518c] 6000 00b4                 bra        $00065242
[00065190] 302f 0010                 move.w     16(a7),d0
[00065194] 671a                      beq.s      $000651B0
[00065196] 0c6f 0002 0034            cmpi.w     #$0002,52(a7)
[0006519c] 6c12                      bge.s      $000651B0
...
[00065398] 6000 00b4                 bra        $0006544E
[0006539c] 302f 0010                 move.w     16(a7),d0
[000653a0] 671a                      beq.s      $000653BC
[000653a2] 0c6f 0002 0034            cmpi.w     #$0002,52(a7)
[000653a8] 6c12                      bge.s      $000653BC
...
[000656c4] 6600 02fa                 bne        $000659C0
...
[000656fa] 6700 021a                 beq        $00065916
...
[0006570e] 6f00 0206                 ble        $00065916
...
[000658ac] 6706                      beq.s      $000658B4
[000658ae] 5340                      subq.w     #1,d0
[000658b0] 671e                      beq.s      $000658D0
[000658b2] 6038                      bra.s      $000658EC
