...
[0004a378] 6700 00b2                 beq        IsDeadKey_4
...
[0004a3b0] 665a                      bne.s      IsDeadKey_5
[0004a3b2] 2017                      move.l     (a7),d0
[0004a3b4] 6756                      beq.s      IsDeadKey_5
...
[0004a3d2] 6738                      beq.s      IsDeadKey_5
...
[0004a40a] 6020                      bra.s      IsDeadKey_4
IsDeadKey_5:
...
[0004a456] 6730                      beq.s      IsDeadKey_6
...
[0004a472] 6714                      beq.s      IsDeadKey_6
...
[0004a540] 6000 0360                 bra        evkeybrd_3
evkeybrd_4:
...
[0004a56e] 6608                      bne.s      evkeybrd_6
[0004a570] 302f 0004                 move.w     4(a7),d0
[0004a574] 6000 032c                 bra        evkeybrd_3
evkeybrd_6:
...
[0004a58a] 662e                      bne.s      evkeybrd_7
...
[0004a5d2] 670e                      beq.s      evkeybrd_10
...
[0004a5e8] 6600 01e0                 bne        evkeybrd_11
[0004a5ec] 202f 001c                 move.l     28(a7),d0
[0004a5f0] 6700 0152                 beq        evkeybrd_12
[0004a5f4] 4eb9 0005 7b82            jsr        Awi_modal
[0004a5fa] 2008                      move.l     a0,d0
[0004a5fc] 6628                      bne.s      evkeybrd_13
...
[0004a620] 6b04                      bmi.s      evkeybrd_13
[0004a622] 6000 027a                 bra        evkeybrd_14
evkeybrd_13:
...
[0004a638] 6700 0088                 beq        evkeybrd_15
[0004a63c] 4eb9 0005 7b82            jsr        Awi_modal
[0004a642] 2008                      move.l     a0,d0
[0004a644] 6628                      bne.s      evkeybrd_16
...
[0004a668] 6b04                      bmi.s      evkeybrd_16
[0004a66a] 6000 0232                 bra        evkeybrd_14
evkeybrd_16:
...
[0004a690] 6b04                      bmi.s      evkeybrd_17
[0004a692] 6000 020a                 bra        evkeybrd_14
evkeybrd_17:
...
[0004a6b8] 6b04                      bmi.s      evkeybrd_18
[0004a6ba] 6000 01e2                 bra        evkeybrd_14
evkeybrd_18:
[0004a6be] 6000 0084                 bra        evkeybrd_12
evkeybrd_15:
...
[0004a6e4] 6b04                      bmi.s      evkeybrd_19
[0004a6e6] 6000 01b6                 bra        evkeybrd_14
evkeybrd_19:
...
[0004a70c] 6b04                      bmi.s      evkeybrd_20
[0004a70e] 6000 018e                 bra        evkeybrd_14
evkeybrd_20:
[0004a712] 4eb9 0005 7b82            jsr        Awi_modal
[0004a718] 2008                      move.l     a0,d0
[0004a71a] 6628                      bne.s      evkeybrd_12
...
[0004a73e] 6b04                      bmi.s      evkeybrd_12
[0004a740] 6000 015c                 bra        evkeybrd_14
evkeybrd_12:
[0004a744] 4eb9 0005 7b82            jsr        Awi_modal
[0004a74a] 2008                      move.l     a0,d0
[0004a74c] 6600 007c                 bne.w      evkeybrd_11
[0004a750] 202f 0018                 move.l     24(a7),d0
[0004a754] 6774                      beq.s      evkeybrd_11
...
[0004a778] 6a50                      bpl.s      evkeybrd_11
...
[0004a79c] 6b04                      bmi.s      evkeybrd_21
[0004a79e] 6000 00fe                 bra        evkeybrd_14
evkeybrd_21:
...
[0004a7c4] 6b04                      bmi.s      evkeybrd_11
[0004a7c6] 6000 00d6                 bra        evkeybrd_14
evkeybrd_11:
...
[0004a7f4] 6604                      bne.s      evkeybrd_22
[0004a7f6] 6000 00a6                 bra        evkeybrd_14
evkeybrd_22:
[0004a7fa] 202f 001c                 move.l     28(a7),d0
[0004a7fe] 6726                      beq.s      evkeybrd_23
...
[0004a842] 6748                      beq.s      evkeybrd_25
...
[0004a8e8] 6a06                      bpl.s      ev_dobutton_1
[0004a8ea] 70ff                      moveq.l    #-1,d0
[0004a8ec] 6000 0208                 bra        ev_dobutton_2
ev_dobutton_1:
...
[0004a916] 6b1c                      bmi.s      ev_dobutton_4
...
[0004a932] 67cc                      beq.s      ev_dobutton_5
ev_dobutton_4:
[0004a934] 302f 000a                 move.w     10(a7),d0
[0004a938] 6b06                      bmi.s      ev_dobutton_6
...
[0004aa38] 6606                      bne.s      ev_dobutton_7
[0004aa3a] 70ff                      moveq.l    #-1,d0
[0004aa3c] 6000 00b8                 bra        ev_dobutton_2
ev_dobutton_7:
[0004aa40] 0c6f 0002 0014            cmpi.w     #$0002,20(a7)
[0004aa46] 6d04                      blt.s      ev_dobutton_16
[0004aa48] 7201                      moveq.l    #1,d1
[0004aa4a] 6002                      bra.s      ev_dobutton_17
ev_dobutton_16:
...
[0004aa62] 670c                      beq.s      ev_dobutton_18
...
[0004aabe] 660c                      bne.s      ev_dobutton_20
[0004aac0] 302f 0010                 move.w     16(a7),d0
[0004aac4] 6eb8                      bgt.s      ev_dobutton_21
[0004aac6] 302f 000e                 move.w     14(a7),d0
[0004aaca] 67b2                      beq.s      ev_dobutton_21
ev_dobutton_20:
[0004aacc] 302f 000e                 move.w     14(a7),d0
[0004aad0] 6720                      beq.s      ev_dobutton_19
[0004aad2] 302f 0010                 move.w     16(a7),d0
[0004aad6] 6e1a                      bgt.s      ev_dobutton_19
...
[0004ab56] 6006                      bra.s      evmwheel_4
[0004ab58] 6004                      bra.s      evmwheel_4
evmwheel_3:
...
[0004ac24] 6700 0136                 beq        evbutton_4
...
[0004ac4e] 6750                      beq.s      evbutton_5
...
[0004acd0] 602a                      bra.s      evbutton_8
evbutton_7:
[0004acd2] 7020                      moveq.l    #32,d0
[0004acd4] c06f 0010                 and.w      16(a7),d0
[0004acd8] 6722                      beq.s      evbutton_8
...
[0004ad00] 6656                      bne.s      evbutton_9
[0004ad02] 7002                      moveq.l    #2,d0
[0004ad04] c06f 0010                 and.w      16(a7),d0
[0004ad08] 6724                      beq.s      evbutton_10
...
[0004ad2c] 602a                      bra.s      evbutton_9
evbutton_10:
[0004ad2e] 7020                      moveq.l    #32,d0
[0004ad30] c06f 0010                 and.w      16(a7),d0
[0004ad34] 6722                      beq.s      evbutton_9
...
[0004ad9e] 6000 009c                 bra        evbutton_2
evbutton_13:
...
[0004adb2] 6724                      beq.s      evbutton_14
[0004adb4] 302f 0018                 move.w     24(a7),d0
[0004adb8] 671e                      beq.s      evbutton_14
...
[0004adde] 6058                      bra.s      evbutton_11
evbutton_12:
...
[0004aecc] 6000 01b0                 bra        evmouse_2
evmouse_4:
...
[0004affa] 6b08                      bmi.s      evmouse_10
[0004affc] 302f 000e                 move.w     14(a7),d0
[0004b000] 6f00 ff54                 ble        evmouse_11
evmouse_10:
...
[0004b092] 6604                      bne.s      Aev_mess_1
[0004b094] 6000 00b4                 bra        Aev_mess_2
Aev_mess_1:
[0004b098] 2079 0010 ee4e            movea.l    ACSblk,a0
[0004b09e] 3028 027e                 move.w     638(a0),d0
[0004b0a2] 6704                      beq.s      Aev_mess_3
[0004b0a4] 6000 00a4                 bra        Aev_mess_2
Aev_mess_3:
...
[0004b184] 6710                      beq.s      ACSeventhandler_1
[0004b186] 302f 000a                 move.w     10(a7),d0
[0004b18a] 6704                      beq.s      ACSeventhandler_2
[0004b18c] 7001                      moveq.l    #1,d0
[0004b18e] 6002                      bra.s      ACSeventhandler_3
ACSeventhandler_2:
[0004b190] 4240                      clr.w      d0
ACSeventhandler_3:
[0004b192] 3e80                      move.w     d0,(a7)
[0004b194] 6002                      bra.s      ACSeventhandler_4
ACSeventhandler_1:
...
[0004b1fc] 67d0                      beq.s      ACSeventhandler_8
ACSeventhandler_5:
...
[0004b368] 670a                      beq.s      ACSeventhandler_15
...
[0004b3c6] 6706                      beq.s      ACSeventhandler_18
...
[0004b410] 6610                      bne.s      ACSeventhandler_19
[0004b412] 7004                      moveq.l    #4,d0
[0004b414] c06f 0002                 and.w      2(a7),d0
[0004b418] 6704                      beq.s      ACSeventhandler_20
