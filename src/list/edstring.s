...
[00035f4a] 6700 0114                 beq        add_string_1
[00035f4e] 222a 0004                 move.l     4(a2),d1
[00035f52] 6700 010c                 beq        add_string_1
...
[00035f9e] 6600 0084                 bne        add_string_4
[00035fa2] 4245                      clr.w      d5
[00035fa4] 6030                      bra.s      add_string_5
add_string_7:
...
[00035fd2] 6608                      bne.s      add_string_6
[00035fd4] 5245                      addq.w     #1,d5
add_string_5:
[00035fd6] ba7c 0003                 cmp.w      #$0003,d5
[00035fda] 6dca                      blt.s      add_string_7
add_string_6:
[00035fdc] ba7c 0003                 cmp.w      #$0003,d5
[00035fe0] 673c                      beq.s      add_string_8
[00035fe2] 4245                      clr.w      d5
[00035fe4] 602c                      bra.s      add_string_9
add_string_11:
...
[0003603a] 6724                      beq.s      add_string_1
...
[0003605e] 6604                      bne.s      add_string_14
add_string_1:
[00036060] 91c8                      suba.l     a0,a0
[00036062] 600e                      bra.s      add_string_15
add_string_14:
...
[00036088] 6604                      bne.s      change_string_1
[0003608a] 91c8                      suba.l     a0,a0
[0003608c] 6074                      bra.s      change_string_2
change_string_1:
...
[000360a8] 6e16                      bgt.s      change_string_3
...
[000360be] 602e                      bra.s      change_string_4
change_string_3:
...
[000360d2] 6606                      bne.s      change_string_5
[000360d4] 254d 0004                 move.l     a5,4(a2)
[000360d8] 6014                      bra.s      change_string_4
change_string_5:
...
[000360f6] 6708                      beq.s      change_string_6
...
[0003611e] 6e36                      bgt.s      del_string_1
[00036120] 286b 0012                 movea.l    18(a3),a4
[00036124] 220c                      move.l     a4,d1
[00036126] 670c                      beq.s      del_string_2
...
[000361aa] 51c9 fffc                 dbf        d1,serv_str_1
[000361ae] 32d8                      move.w     (a0)+,(a1)+
[000361b0] 3200                      move.w     d0,d1
[000361b2] 5341                      subq.w     #1,d1
[000361b4] 6710                      beq.s      serv_str_2
[000361b6] 5341                      subq.w     #1,d1
[000361b8] 6700 0090                 beq        serv_str_3
[000361bc] 5341                      subq.w     #1,d1
[000361be] 6700 01be                 beq        serv_str_4
[000361c2] 6000 0242                 bra        serv_str_5
serv_str_2:
[000361c6] 4243                      clr.w      d3
[000361c8] 6076                      bra.s      serv_str_6
serv_str_7:
...
[000361f0] 6700 0214                 beq        serv_str_5
...
[0003623a] 6700 01ca                 beq        serv_str_5
[0003623e] 5243                      addq.w     #1,d3
serv_str_6:
[00036240] b67c 0003                 cmp.w      #$0003,d3
[00036244] 6d84                      blt.s      serv_str_7
[00036246] 6000 01c2                 bra        serv_str_8
serv_str_3:
...
[0003626e] 6014                      bra.s      serv_str_9
serv_str_10:
...
[00036286] 6ee8                      bgt.s      serv_str_10
[00036288] 4246                      clr.w      d6
[0003628a] 6000 0072                 bra.w      serv_str_11
serv_str_19:
...
[000362bc] 670a                      beq.s      serv_str_12
[000362be] 0c2d 0001 0002            cmpi.b     #$01,2(a5)
[000362c4] 6602                      bne.s      serv_str_12
[000362c6] 4210                      clr.b      (a0)
serv_str_12:
[000362c8] 200d                      move.l     a5,d0
[000362ca] 6704                      beq.s      serv_str_13
[000362cc] 1215                      move.b     (a5),d1
[000362ce] 66de                      bne.s      serv_str_14
serv_str_13:
[000362d0] 4243                      clr.w      d3
[000362d2] 6020                      bra.s      serv_str_15
serv_str_17:
...
[000362f0] 6706                      beq.s      serv_str_16
[000362f2] 5243                      addq.w     #1,d3
serv_str_15:
[000362f4] b843                      cmp.w      d3,d4
[000362f6] 6edc                      bgt.s      serv_str_17
serv_str_16:
[000362f8] b843                      cmp.w      d3,d4
[000362fa] 6708                      beq.s      serv_str_18
[000362fc] 5246                      addq.w     #1,d6
serv_str_11:
[000362fe] ba46                      cmp.w      d6,d5
[00036300] 6e00 ff8c                 bgt.w      serv_str_19
serv_str_18:
[00036304] ba46                      cmp.w      d6,d5
[00036306] 6f00 0102                 ble        serv_str_8
[0003630a] 4243                      clr.w      d3
[0003630c] 6066                      bra.s      serv_str_20
serv_str_21:
...
[00036378] 6d94                      blt.s      serv_str_21
[0003637a] 6000 008e                 bra        serv_str_8
serv_str_4:
[0003637e] 4243                      clr.w      d3
[00036380] 6000 007a                 bra.w      serv_str_22
serv_str_27:
...
[000363be] 6036                      bra.s      serv_str_23
serv_str_26:
...
[000363dc] 6616                      bne.s      serv_str_24
...
[000363f2] 6006                      bra.s      serv_str_25
serv_str_24:
[000363f4] 5246                      addq.w     #1,d6
serv_str_23:
[000363f6] ba46                      cmp.w      d6,d5
[000363f8] 6ec6                      bgt.s      serv_str_26
serv_str_25:
[000363fa] 5243                      addq.w     #1,d3
serv_str_22:
[000363fc] b67c 0003                 cmp.w      #$0003,d3
[00036400] 6d00 ff82                 blt.w      serv_str_27
[00036404] 6004                      bra.s      serv_str_8
serv_str_5:
[00036406] 4240                      clr.w      d0
[00036408] 6002                      bra.s      serv_str_28
serv_str_8:
...
[00036432] 6604                      bne.s      copy_str_1
[00036434] 91c8                      suba.l     a0,a0
[00036436] 601c                      bra.s      copy_str_2
copy_str_1:
...
[0003648a] 6606                      bne.s      new_work_1
[0003648c] 91c8                      suba.l     a0,a0
[0003648e] 6000 00dc                 bra        new_work_2
new_work_1:
...
[000364a8] 6f00 00b8                 ble        new_work_3
...
[000364c0] 607c                      bra.s      new_work_4
new_work_6:
...
[000364f2] 6606                      bne.s      new_work_5
...
[00036540] 6e00 ff80                 bgt.w      new_work_6
...
[000cefc8]                           dc.w $0000
[000cefca]                           dc.w $0000
[000cefcc] 000cd0a2                  dc.l proto_string
[000cefd0]                           dc.w $0000
[000cefd2]                           dc.w $0000
[000cefd4]                           dc.w $000e
[000cefd6]                           dc.w $0000
...
[000cf00e]                           dc.w $0000
[000cf010]                           dc.w $0000
[000cf012] 000b3d54                  dc.l WI_STRING
[000cf016] 000cd0f7                  dc.l st_list
[000cf01a] 000cd105                  dc.l st_name
[000cf01e]                           dc.w $271a
[000cf020] 000cefc8                  dc.l protostring
[000cf024] 00036416                  dc.l copy_str
[000cf028] 00036108                  dc.l del_string
[000cf02c] 0003645a                  dc.l new_work
[000cf030] 0003618e                  dc.l serv_str
free_string:
[000cf034]                           dc.w $0000
[000cf036]                           dc.w $0000
[000cf038]                           dc.w $0000
