...
[00016fc2] 6d10                      blt.s      next_trans_1
...
[0001701e] 6000 024e                 bra        fix_all_4
fix_all_3:
...
[00017118] 6de0                      blt.s      fix_all_6
[0001711a] 4243                      clr.w      d3
[0001711c] 601a                      bra.s      fix_all_7
...
[0001721a] 6af0                      bpl.s      fix_all_10
[0001721c] 4243                      clr.w      d3
[0001721e] 601a                      bra.s      fix_all_11
...
[0001723e] 6de0                      blt.s      fix_all_12
[00017240] 4243                      clr.w      d3
[00017242] 601a                      bra.s      fix_all_13
...
[00017262] 6de0                      blt.s      fix_all_14
...
[000172d2] 6de6                      blt.s      unfix_all_6
[000172d4] 4243                      clr.w      d3
[000172d6] 6014                      bra.s      unfix_all_7
...
[000172f0] 6de6                      blt.s      unfix_all_8
...
[00017370] 600c                      bra.s      unfix_all_9
...
[00017380] 6af0                      bpl.s      unfix_all_10
...
[00017438] 601a                      bra.s      unfix_all_11
...
[00017458] 6de0                      blt.s      unfix_all_12
[0001745a] 4243                      clr.w      d3
[0001745c] 601a                      bra.s      unfix_all_13
...
[0001747c] 6de0                      blt.s      unfix_all_14
...
[00017576] 6764                      beq.s      rd_all_3
[00017578] 6e10                      bgt.s      rd_all_4
[0001757a] 907c 0064                 sub.w      #$0064,d0
[0001757e] 671e                      beq.s      rd_all_5
[00017580] 907c 0064                 sub.w      #$0064,d0
[00017584] 6756                      beq.s      rd_all_3
[00017586] 6000 00fe                 bra        rd_all_6
rd_all_4:
[0001758a] 907c 012c                 sub.w      #$012C,d0
[0001758e] 6700 00ac                 beq        rd_all_7
[00017592] 907c 0064                 sub.w      #$0064,d0
[00017596] 6700 00ce                 beq        rd_all_8
[0001759a] 6000 00ea                 bra        rd_all_6
rd_all_5:
...
[00017658] 6704                      beq.s      rd_all_11
[0001765a] 7201                      moveq.l    #1,d1
[0001765c] 6002                      bra.s      rd_all_12
rd_all_11:
[0001765e] 4241                      clr.w      d1
rd_all_12:
[00017660] 3941 020e                 move.w     d1,526(a4)
[00017664] 6042                      bra.s      rd_all_13
rd_all_8:
...
[00017792] 6600 ff64                 bne        rd_all_21
...
[000179c4] 6700 0084                 beq        unfix_icon_1
...
[000179da] 660a                      bne.s      unfix_icon_2
...
[00017a48] 6040                      bra.s      unfix_icon_3
unfix_icon_1:
...
[00017aa0] 601a                      bra.s      fix_labels_1
...
[00017abe] 66e2                      bne.s      fix_labels_2
...
[00017adc] 6028                      bra.s      unfix_labels_1
...
[00017b0c] 6dd0                      blt.s      unfix_labels_4
...
[00017b38] 6704                      beq.s      fix_list_3
...
[00017b52] 6ed8                      bgt.s      fix_list_4
fix_list_1:
...
[00017b8e] 6704                      beq.s      unfix_list_3
...
[00017ba2] 6ed2                      bgt.s      unfix_list_4
unfix_list_1:
...
[00017bca] 6000 007e                 bra.w      fix_object_1
...
[00017bea] 622e                      bhi.s      fix_object_2
[00017bec] d040                      add.w      d0,d0
[00017bee] 303b 0006                 move.w     $00017BF6(pc,d0.w),d0
[00017bf2] 4efb 0002                 jmp        $00017BF6(pc,d0.w)
J1:
[00017bf6] 002e                      dc.w $002e   ; fix_object_3-J1
[00017bf8] 001a                      dc.w $001a   ; fix_object_4-J1
[00017bfa] 001a                      dc.w $001a   ; fix_object_4-J1
[00017bfc] 001a                      dc.w $001a   ; fix_object_4-J1
[00017bfe] 001a                      dc.w $001a   ; fix_object_4-J1
[00017c00] 002e                      dc.w $002e   ; fix_object_3-J1
[00017c02] 001a                      dc.w $001a   ; fix_object_4-J1
[00017c04] 002e                      dc.w $002e   ; fix_object_3-J1
[00017c06] 001a                      dc.w $001a   ; fix_object_4-J1
[00017c08] 001a                      dc.w $001a   ; fix_object_4-J1
[00017c0a] 001a                      dc.w $001a   ; fix_object_4-J1
[00017c0c] 001a                      dc.w $001a   ; fix_object_4-J1
[00017c0e] 001a                      dc.w $001a   ; fix_object_4-J1
fix_object_4:
[00017c10] 41ea 0014                 lea.l      20(a2),a0
[00017c14] 6100 f376                 bsr        fix_ob
[00017c18] 600a                      bra.s      fix_object_3
fix_object_2:
...
[00017c4c] 6e00 ff80                 bgt.w      fix_object_5
...
[00017c76] 6000 007e                 bra.w      unfix_object_1
...
[00017c96] 622e                      bhi.s      unfix_object_2
[00017c98] d040                      add.w      d0,d0
[00017c9a] 303b 0006                 move.w     $00017CA2(pc,d0.w),d0
[00017c9e] 4efb 0002                 jmp        $00017CA2(pc,d0.w)
J2:
[00017ca2] 002e                      dc.w $002e   ; unfix_object_3-J2
[00017ca4] 001a                      dc.w $001a   ; unfix_object_4-J2
[00017ca6] 001a                      dc.w $001a   ; unfix_object_4-J2
[00017ca8] 001a                      dc.w $001a   ; unfix_object_4-J2
[00017caa] 001a                      dc.w $001a   ; unfix_object_4-J2
[00017cac] 002e                      dc.w $002e   ; unfix_object_3-J2
[00017cae] 001a                      dc.w $001a   ; unfix_object_4-J2
[00017cb0] 002e                      dc.w $002e   ; unfix_object_3-J2
[00017cb2] 001a                      dc.w $001a   ; unfix_object_4-J2
[00017cb4] 001a                      dc.w $001a   ; unfix_object_4-J2
[00017cb6] 001a                      dc.w $001a   ; unfix_object_4-J2
[00017cb8] 001a                      dc.w $001a   ; unfix_object_4-J2
[00017cba] 001a                      dc.w $001a   ; unfix_object_4-J2
unfix_object_4:
[00017cbc] 41ea 0014                 lea.l      20(a2),a0
[00017cc0] 6100 f2da                 bsr        unfix_ob
[00017cc4] 600a                      bra.s      unfix_object_3
unfix_object_2:
...
[00017cf8] 6e00 ff80                 bgt.w      unfix_object_5
...
[00017dec] 660a                      bne.s      unfix_window2_1
...
[00017e3c] 660a                      bne.s      unfix_user1_1
...
[00017e8c] 660a                      bne.s      unfix_user2_1
...
[00017ece] 6740                      beq.s      release_err_1
[00017ed0] 7601                      moveq.l    #1,d3
[00017ed2] 6024                      bra.s      release_err_2
...
[00017ee2] 671e                      beq.s      release_err_3
...
[00017f00] 6dd2                      blt.s      release_err_4
release_err_3:
...
[00017f20] 6018                      bra.s      free_acs_1
...
[00017f3c] 66e4                      bne.s      free_acs_2
...
[00018002] 6706                      beq.s      objmalloc_6
...
[0001803a] 6f42                      ble.s      objextent_1
...
[0001804c] 6604                      bne.s      objextent_2
[0001804e] 70ff                      moveq.l    #-1,d0
[00018050] 602e                      bra.s      objextent_3
objextent_2:
[00018052] 202a 0004                 move.l     4(a2),d0
[00018056] 671a                      beq.s      objextent_4
...
[00018098] 6002                      bra.s      makeformat_1
...
[000180a8] 6706                      beq.s      makeformat_2
[000180aa] b67c 0004                 cmp.w      #$0004,d3
[000180ae] 6dea                      blt.s      makeformat_3
makeformat_2:
[000180b0] 524a                      addq.w     #1,a2
[000180b2] 4a43                      tst.w      d3
[000180b4] 6f34                      ble.s      makeformat_4
[000180b6] 204a                      movea.l    a2,a0
[000180b8] 4244                      clr.w      d4
[000180ba] 6014                      bra.s      makeformat_5
...
[000180d2] 66e8                      bne.s      makeformat_6
...
[000180e8] 6002                      bra.s      makeformat_7
makeformat_4:
...
[00018118] 6b24                      bmi.s      uniquename_1
...
[0001814e] 6060                      bra.s      uniquename_2
...
[00018162] 6b50                      bmi.s      uniquename_3
[00018164] 4a40                      tst.w      d0
[00018166] 6646                      bne.s      uniquename_4
[00018168] b5d6                      cmpa.l     (a6),a2
[0001816a] 6742                      beq.s      uniquename_4
[0001816c] 4a43                      tst.w      d3
[0001816e] 6b3a                      bmi.s      uniquename_5
...
[000181f2] 66f6                      bne.s      objname_2
[000181f4] 2292                      move.l     (a2),(a1)
[000181f6] 600e                      bra.s      objname_3
...
[00018214] 6604                      bne.s      objname_4
[00018216] 200d                      move.l     a5,d0
[00018218] 66de                      bne.s      objname_5
objname_4:
