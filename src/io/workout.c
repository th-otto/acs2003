...
OBJECT INFO_OB_WH =            { -1,  1,  2, G_BOX,  0x0000, 0x0000, C_UNION(0x00011101L), 0x0000, 0x0000, 0x000b, 0x0002 };
static OBJECT _01_INFO_OB_WH = {  2, -1, -1, G_TEXT, 0x0000, 0x0000, C_UNION(&TEDINFO_02), 0x0000, 0x0000, 0x000b, 0x0001 };
static OBJECT _02_INFO_OB_WH = {  0, -1, -1, G_TEXT, 0x0020, 0x0000, C_UNION(&TEDINFO_02), 0x0000, 0x0001, 0x000b, 0x0001 };

OBJECT NEW2_LABEL =             { -1,  1,  5, G_USERDEF, 0x0000, 0x0010, C_UNION(&A_3DBUTTON03), 0x0000, 0x0000, 0x0024, 0x0006 };
static OBJECT  _01_NEW2_LABEL = {  3,  2,  2, G_USERDEF, 0x0040, 0x0000, C_UNION(&A_INNERFRAME02), 0x0001, 0x0000, 0x0022, 0x0003 };
static OBJECT  _02_NEW2_LABEL = {  1, -1, -1, G_USERDEF, 0x0008, 0x0010, C_UNION(&A_BOXED02), 0x0001, 0x0001, 0x0020, 0x0001 };
static OBJECT  _03_NEW2_LABEL = {  5, -1, -1, G_USERDEF, 0x4007, 0x0010, C_UNION(&A_3DBUTTON02), 0x0004, 0x0003, 0x000c, 0x0002 };
static AOBJECT _03aNEW2_LABEL = { NULL, NULL, 0x8000, 0x884f, NULL, NULL, 0, 0 };
static OBJECT  _05_NEW2_LABEL = {  0, -1, -1, G_USERDEF, 0x4005, 0x0010, C_UNION(&A_3DBUTTON05), 0x0013, 0x0003, 0x000c, 0x0002 };
static AOBJECT _05aNEW2_LABEL = { NULL, NULL, 0x8020, 0x8841, NULL, NULL, 0, 0 };

OBJECT NEW_LABEL =             { -1,  1,  3, G_USERDEF, 0x0000, 0x0010, C_UNION(&A_3DBUTTON03), 0x0000, 0x0000, 0x0024, 0x0006 };
static OBJECT  _01_NEW_LABEL = {  3,  2,  2, G_USERDEF, 0x0040, 0x0000, C_UNION(&A_INNERFRAME02), 0x0001, 0x0000, 0x0022, 0x0003 };
static OBJECT  _02_NEW_LABEL = {  1, -1, -1, G_USERDEF, 0x0008, 0x0010, C_UNION(&A_BOXED02), 0x0001, 0x0001, 0x001f, 0x0001 };
static OBJECT  _03_NEW_LABEL = {  0, -1, -1, G_USERDEF, 0x4007, 0x0010, C_UNION(&A_3DBUTTON02), 0x000c, 0x0003, 0x000c, 0x0002 };
static AOBJECT _03aNEW_LABEL = { chk_new_label, NULL, 0x8020, 0x884f, NULL, NULL, 0, 0 };

OBJECT OUTPUT_INFO =            { -1,  1,  1, G_BOX, 0x0000, 0x0000, C_UNION(0x00ff1178L), 0, 0, 44, 11 };
static OBJECT _01_OUTPUT_INFO = {  0,  2,  4, G_USERDEF, 0x0000, 0x0010, C_UNION(&A_3DBUTTON03), 0, 0, 44, 11 };
static OBJECT _02_OUTPUT_INFO = {  4,  3,  3, G_USERDEF, 0x0000, 0x0010, C_UNION(&A_3DBUTTON01), 2, 1, 40, 1 };
static OBJECT _03_OUTPUT_INFO = {  2, -1, -1, G_BOXTEXT, 0x0000, 0x0500, C_UNION(&TEDINFO_01), 0, 0, 40, 1 };
static OBJECT _04_OUTPUT_INFO = {  1,  5, 12, G_USERDEF, 0x0000, 0x0010, C_UNION(&A_3DBUTTON01), 2, 3, 40, 7 };
static OBJECT _05_OUTPUT_INFO = {  6, -1, -1, G_STRING, 0x0000, 0x0000, C_UNION(TEXT_02), 0, 0, 8, 1 };
static OBJECT _06_OUTPUT_INFO = {  7, -1, -1, G_BOXTEXT, 0x0000, 0x0000, C_UNION(&TEDINFO_064), 9, 0, 31, 1 };
static OBJECT _07_OUTPUT_INFO = {  8, -1, -1, G_STRING, 0x0000, 0x0000, C_UNION(TEXT_03), 0, 2, 6, 1 };
static OBJECT _08_OUTPUT_INFO = {  9, -1, -1, G_BOXTEXT, 0x0000, 0x0000, C_UNION(&TEDINFO_064), 9, 2, 31, 1 };
static OBJECT _09_OUTPUT_INFO = { 10, -1, -1, G_STRING, 0x0000, 0x0000, C_UNION(TEXT_04), 0, 4, 6, 1 };
static OBJECT _10_OUTPUT_INFO = { 11, -1, -1, G_BOXTEXT, 0x0000, 0x0000, C_UNION(&TEDINFO_064), 9, 4, 31, 1 };
static OBJECT _11_OUTPUT_INFO = { 12, -1, -1, G_STRING, 0x0000, 0x0000, C_UNION(TEXT_05), 0, 6, 7, 1 };
static OBJECT _12_OUTPUT_INFO = {  4, -1, -1, G_BOXTEXT, 0x0020, 0x0000, C_UNION(&TEDINFO_064), 9, 6, 31, 1 };
