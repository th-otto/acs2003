...
[00028408] 6700 0106                 beq        edar_arr_1
...
[00028452] 6f00 00b4                 ble        edar_arr_2
...
[00028478] 6262                      bhi.s      edar_arr_3
[0002847a] d442                      add.w      d2,d2
[0002847c] 343b 2006                 move.w     $00028484(pc,d2.w),d2
[00028480] 4efb 2002                 jmp        $00028484(pc,d2.w)
J10:
[00028484] 0058                      dc.w $0058   ; edar_arr_3-J10
[00028486] 0012                      dc.w $0012   ; edar_arr_4-J10
[00028488] 0036                      dc.w $0036   ; edar_arr_5-J10
[0002848a] 0012                      dc.w $0012   ; edar_arr_4-J10
[0002848c] 0036                      dc.w $0036   ; edar_arr_5-J10
[0002848e] 0012                      dc.w $0012   ; edar_arr_4-J10
[00028490] 0036                      dc.w $0036   ; edar_arr_5-J10
[00028492] 0012                      dc.w $0012   ; edar_arr_4-J10
[00028494] 0036                      dc.w $0036   ; edar_arr_5-J10
edar_arr_4:
...
[000284b8] 6022                      bra.s      edar_arr_3
edar_arr_5:
...
[00028544] 6b28                      bmi.s      edar_col_1
...
[0002858a] 6700 012e                 beq        edar_ends_1
...
[000285d4] 6f00 00dc                 ble        edar_ends_2
...
[0002861e] 6010                      bra.s      edar_ends_7
edar_ends_6:
...
[00028634] 670e                      beq.s      edar_ends_8
[00028636] 5340                      subq.w     #1,d0
[00028638] 672c                      beq.s      edar_ends_9
[0002863a] 5340                      subq.w     #1,d0
[0002863c] 6706                      beq.s      edar_ends_8
[0002863e] 5340                      subq.w     #1,d0
[00028640] 6724                      beq.s      edar_ends_9
[00028642] 6042                      bra.s      edar_ends_10
edar_ends_8:
...
[00028664] 6020                      bra.s      edar_ends_10
edar_ends_9:
...
[0002870e] 6700 0112                 beq        edar_len_1
...
[00028758] 6f00 00c0                 ble        edar_len_2
...
[0002876a] 670e                      beq.s      edar_len_3
[0002876c] 5340                      subq.w     #1,d0
[0002876e] 6712                      beq.s      edar_len_4
[00028770] 5340                      subq.w     #1,d0
[00028772] 6716                      beq.s      edar_len_5
[00028774] 5340                      subq.w     #1,d0
[00028776] 671a                      beq.s      edar_len_6
[00028778] 601e                      bra.s      edar_len_7
edar_len_3:
[0002877a] 0290 fbff ffff            andi.l     #$FBFFFFFF,(a0)
[00028780] 6016                      bra.s      edar_len_7
edar_len_4:
[00028782] 0290 bfff ffff            andi.l     #$BFFFFFFF,(a0)
[00028788] 600e                      bra.s      edar_len_7
edar_len_5:
[0002878a] 0090 0400 0000            ori.l      #$04000000,(a0)
[00028790] 6006                      bra.s      edar_len_7
edar_len_6:
[00028792] 0090 4000 0000            ori.l      #$40000000,(a0)
edar_len_7:
[00028798] 3003                      move.w     d3,d0
[0002879a] 5340                      subq.w     #1,d0
[0002879c] 670e                      beq.s      edar_len_8
[0002879e] 5340                      subq.w     #1,d0
[000287a0] 672c                      beq.s      edar_len_9
[000287a2] 5340                      subq.w     #1,d0
[000287a4] 6706                      beq.s      edar_len_8
[000287a6] 5340                      subq.w     #1,d0
[000287a8] 6724                      beq.s      edar_len_9
[000287aa] 6042                      bra.s      edar_len_10
edar_len_8:
...
[000287cc] 6020                      bra.s      edar_len_10
edar_len_9:
...
[00028840] 6700 00b4                 beq        edar_stil_1
...
[00028888] 6f64                      ble.s      edar_stil_2
...
[00028966] 6606                      bne.s      object_tree_1
[00028968] 91c8                      suba.l     a0,a0
[0002896a] 6000 0284                 bra        object_tree_2
object_tree_1:
...
[000289de] 6608                      bne.s      object_tree_3
[000289e0] 0095 0000 0001            ori.l      #$00000001,(a5)
[000289e6] 6006                      bra.s      object_tree_4
object_tree_3:
...
[00028a34] 6238                      bhi.s      object_tree_5
[00028a36] d040                      add.w      d0,d0
[00028a38] 303b 0006                 move.w     $00028A40(pc,d0.w),d0
[00028a3c] 4efb 0002                 jmp        $00028A40(pc,d0.w)
J11:
[00028a40] 0010                      dc.w $0010   ; object_tree_6-J11
[00028a42] 0018                      dc.w $0018   ; object_tree_7-J11
[00028a44] 0020                      dc.w $0020   ; object_tree_8-J11
[00028a46] 0028                      dc.w $0028   ; object_tree_9-J11
[00028a48] 0010                      dc.w $0010   ; object_tree_6-J11
[00028a4a] 0018                      dc.w $0018   ; object_tree_7-J11
[00028a4c] 0020                      dc.w $0020   ; object_tree_8-J11
[00028a4e] 0028                      dc.w $0028   ; object_tree_9-J11
object_tree_6:
[00028a50] 2abc 0011 0001            move.l     #$00110001,(a5)
[00028a56] 6016                      bra.s      object_tree_5
object_tree_7:
[00028a58] 2abc 1111 0001            move.l     #$11110001,(a5)
[00028a5e] 600e                      bra.s      object_tree_5
object_tree_8:
[00028a60] 2abc 2211 0001            move.l     #$22110001,(a5)
[00028a66] 6006                      bra.s      object_tree_5
object_tree_9:
...
[00028a82] 6238                      bhi.s      object_tree_10
[00028a84] d040                      add.w      d0,d0
[00028a86] 303b 0006                 move.w     $00028A8E(pc,d0.w),d0
[00028a8a] 4efb 0002                 jmp        $00028A8E(pc,d0.w)
J12:
[00028a8e] 0010                      dc.w $0010   ; object_tree_11-J12
[00028a90] 0018                      dc.w $0018   ; object_tree_12-J12
[00028a92] 0020                      dc.w $0020   ; object_tree_13-J12
[00028a94] 0028                      dc.w $0028   ; object_tree_14-J12
[00028a96] 0010                      dc.w $0010   ; object_tree_11-J12
[00028a98] 0018                      dc.w $0018   ; object_tree_12-J12
[00028a9a] 0020                      dc.w $0020   ; object_tree_13-J12
[00028a9c] 0028                      dc.w $0028   ; object_tree_14-J12
object_tree_11:
[00028a9e] 2abc 0041 0001            move.l     #$00410001,(a5)
[00028aa4] 6016                      bra.s      object_tree_10
object_tree_12:
[00028aa6] 2abc 1141 0001            move.l     #$11410001,(a5)
[00028aac] 600e                      bra.s      object_tree_10
object_tree_13:
[00028aae] 2abc 2241 0001            move.l     #$22410001,(a5)
[00028ab4] 6006                      bra.s      object_tree_10
object_tree_14:
...
[00028b88] 6712                      beq.s      object_tree_19
...
[00028b9a] 6012                      bra.s      object_tree_20
object_tree_19:
...
[00028bc8] 6712                      beq.s      object_tree_21
...
[00028bda] 6012                      bra.s      object_tree_22
object_tree_21:
...
[00028c38] 6704                      beq.s      test_it_1
[00028c3a] 91c8                      suba.l     a0,a0
[00028c3c] 6004                      bra.s      test_it_2
test_it_1:
...
[00028c52] 6704                      beq.s      test_it_3
[00028c54] 91c8                      suba.l     a0,a0
[00028c56] 6004                      bra.s      test_it_4
test_it_3:
