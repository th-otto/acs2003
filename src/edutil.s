...
[00015926] 6606                      bne.s      set_ref_1
[00015928] 2057                      movea.l    (a7),a0
[0001592a] 4210                      clr.b      (a0)
[0001592c] 6010                      bra.s      set_ref_2
set_ref_1:
...
[0001594e] 6606                      bne.s      set_val_1
[00015950] 2057                      movea.l    (a7),a0
[00015952] 4210                      clr.b      (a0)
[00015954] 6010                      bra.s      set_val_2
set_val_1:
...
[00015994] 6700 00f2                 beq        A_rubberbox_1
...
[00015a0a] 677c                      beq.s      A_rubberbox_1
...
[00015a98] 6606                      bne.s      A_rubberbox_4
...
[00015b6a] 6000 049a                 bra        A_rubberbox_5
...
[00015c4e] 6700 0120                 beq        A_rubberbox_12
[00015c52] 202f 000c                 move.l     12(a7),d0
[00015c56] 6700 008c                 beq        A_rubberbox_13
...
[00015ce0] 6000 0084                 bra        A_rubberbox_14
A_rubberbox_13:
...
[00015d7c] 6708                      beq.s      A_rubberbox_15
[00015d7e] 4240                      clr.w      d0
[00015d80] 6000 0288                 bra        A_rubberbox_16
[00015d84] 6006                      bra.s      A_rubberbox_11
A_rubberbox_15:
[00015d86] 7001                      moveq.l    #1,d0
[00015d88] 6000 0280                 bra        A_rubberbox_16
A_rubberbox_11:
...
[00015e0e] 6700 00d8                 beq        A_rubberbox_17
...
[00015efa] 606c                      bra.s      A_rubberbox_18
...
A_rubberbox_5:
[00016006] 6000 fb66                 bra        A_rubberbox_24
A_rubberbox_16:
...
[00016028] 6736                      beq.s      view_grow_1
...
[00016094] 6736                      beq.s      view_shrink_1
...
[00016150] 6b1a                      bmi.s      new_name_1
...
[0001618c] 670c                      beq.s      chk_new_label_1
...
[000161be] 6604                      bne.s      newlabel_1
[000161c0] 6000 008a                 bra        newlabel_2
newlabel_1:
...
[00016270] 6606                      bne.s      new2label_1
[00016272] 4240                      clr.w      d0
[00016274] 6000 00a0                 bra        new2label_2
new2label_1:
...
[0001630e] 6006                      bra.s      new2label_2
[00016310] 6004                      bra.s      new2label_2
new2label_3:
...
[00016330] 6606                      bne.s      wicalc_pos_1
[00016332] 3eaf 000c                 move.w     12(a7),(a7)
[00016336] 601a                      bra.s      wicalc_pos_2
wicalc_pos_1:
...
[00016380] 6604                      bne.s      wi_pos_1
[00016382] 6000 016e                 bra        wi_pos_2
wi_pos_1:
...
[0001651c] 6700 0228                 beq        convert_1
...
[0001654a] 6000 01e8                 bra        convert_2
...
[00016570] 6000 01ae                 bra        convert_3
...
[000165ce] 6700 0104                 beq        convert_4
...
[00016664] 6706                      beq.s      convert_10
...
[00016680] 6706                      beq.s      convert_11
...
[0001669c] 6706                      beq.s      convert_12
...
convert_14:
[000166d2] 6010                      bra.s      convert_15
convert_4:
...
[0001672c] 6d00 fe46                 blt        convert_16
...
[00016740] 6d00 fe0c                 blt        convert_17
[00016744] 6018                      bra.s      convert_18
convert_1:
...
[000167aa] 6f0e                      ble.s      to_cicon_1
...
[0001689a] 6616                      bne.s      to_cicon_4
...
[000168b0] 6056                      bra.s      to_cicon_3
to_cicon_4:
...
[000168d2] 6714                      beq.s      to_cicon_5
...
[000168e6] 6012                      bra.s      to_cicon_6
to_cicon_5:
